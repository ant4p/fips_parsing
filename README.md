...
На выходе получаем папку с файлами json по каждому виду МПК, а так-же общий union.json файл на чуть больше 38000 строк, который создаётся в корне проекта<br/>
Все из созданных json файлов имеют иерархическую структуру, и могут содержать многоуровневые вложенные подгруппы<br/>
<br/>
